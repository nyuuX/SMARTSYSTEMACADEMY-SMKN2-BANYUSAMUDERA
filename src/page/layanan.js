    ...
    return ( 
        ...
        <div className="w-full py-20 h-auto flex flex-col gap-20">
            ...
            <div className="flex sm:flex-col sm:items-center xl:flex-row justify-center w-full gap-36">
                <div className="xl:w-1/4 sm:w-2/4 border shadow-xl rounded-[15px] h-[450px] overflow-hidden">
                    <a href="/startup">
            ...
            <div className="flex sm:flex-col sm:items-center xl:flex-row justify-center w-full gap-36">
                ...
                <div className="xl:w-1/4 sm:w-2/4 border shadow-xl rounded-[15px] overflow-hidden h-[450px]">
