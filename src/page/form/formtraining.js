...
export default function Formtraining() {
    ...
    const Submit = () => {
        Axios.post("http://localhost:3001/insertdatatraining", { 
            fullName: fullName, 
            email: email, 
            instansi: instansi, 
            phone: phone
    ...
    return ( 
        ...
        <div className="bg-banner3 h-[500px] bg-fixed bg-cover bg-center flex flex-col justify-center items-center text-white ">
            <h2 className="text-5xl">Training</h2>
        </div>
        <div className="w-full flex flex-col items-center">
            ...
            <div className="w-1/2">
                <Link to="/training" className="flex items-center mb-10 gap-2 hover:text-pink-500 hover:pl-2 transition-all text-lg"><IoArrowBack/>Kembali</Link>
